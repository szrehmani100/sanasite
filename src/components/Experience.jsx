...
const experiences = [
  {
    ...
    accomplishments: [
      ...
      'Drove cross-team alignment across 5 engineering teams on Roku integration, delivering ahead of revised timeline with 2.5x resourcing increase',
      'Coordinated incident response for silent Kinesis shard failure; led migration to Scala-based E2E testing framework enforcing Smithy schemas',
      'Deprecated legacy Sonos migration endpoint generating 11.3M failed weekly requests at 0.68% success rate',
